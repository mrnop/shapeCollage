...
public class StickerShadow2 extends TextStyle {
	private static final long serialVersionUID = -552769057468009262L;
	private Paint mTextPaint;
	private Paint mTextPaintSticker;
	Rect bounds = new Rect();

	public StickerShadow2() {
		super();
		init();
	}

	public StickerShadow2(Context context) {
		super(context);
		init();
	}
	...
	protected void prepare(Canvas canvas, String text) {
		...
		mTextPaintSticker.setColor(textColor2);
		...
		mTextPaintSticker.setShadowLayer(radius, radius, 10.0f, textColor3);
