...
public class GradientShadow2 extends TextStyle {
	...
	protected void prepare(Canvas canvas, String text) {
		...
		mTextPaintOutline.setShadowLayer(radius,d,d, textColor4);
