...
public class GradientStickerShadow extends TextStyle {
	...
	public GradientStickerShadow() {
		super();
		init();
	}

	public GradientStickerShadow(Context context) {
		super(context);
		init();
	}
...
//		mTextPaintSticker = new Paint();
	...
	protected void prepare(Canvas canvas, String text) {
		...
		mTextPaintSticker.setColor(Color.WHITE);
		...
		mTextPaintSticker.setShadowLayer(radius, d, d, textColor4);
