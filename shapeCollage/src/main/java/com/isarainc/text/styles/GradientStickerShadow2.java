...
public class GradientStickerShadow2 extends TextStyle {
	...
	public GradientStickerShadow2() {
		super();
		init();
	}

	public GradientStickerShadow2(Context context) {
		super(context);
		init();
	}
	...
	protected void prepare(Canvas canvas, String text) {
		...
		int textColor4 = getColor(3);
		int textColor5 = getColor(4);
		...
		mTextPaintSticker.setColor(textColor4);
		...
		mTextPaintSticker.setShadowLayer(radius, d, d, textColor5);
