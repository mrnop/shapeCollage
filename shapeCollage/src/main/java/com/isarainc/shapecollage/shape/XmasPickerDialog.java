...
public class XmasPickerDialog extends DialogFragment {

    private static final String TAG = "XmasPickerDialogFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final List<ShapeInfo> shapes = shapeManager.listShapes("xmas");
