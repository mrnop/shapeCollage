...
public class HorizontalProgressWheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mProgressLinePaint.setColor(getResources().getColor(R.color.color_progress_wheel_line));
    ...
    private void init() {
        mMiddleLineColor = ContextCompat.getColor(getContext(), R.color.color_progress_wheel_line);

        mProgressLineWidth = getContext().getResources()
                .getDimensionPixelSize(R.dimen.width_horizontal_wheel_progress_line);
        mProgressLineHeight = getContext().getResources()
                .getDimensionPixelSize(R.dimen.height_horizontal_wheel_progress_line);
        mProgressLineMargin = getContext().getResources()
                .getDimensionPixelSize(R.dimen.margin_horizontal_wheel_progress_line);
